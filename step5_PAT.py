...
# with command line options: step5 -s PAT --runUnscheduled --nThreads 8 --data --era Run2_2018,pf_badHcalMitigation --scenario pp --conditions 106X_dataRun2_v26 --eventcontent MINIAOD --datatier MINIAODSIM --filein file:AOD.root -n 100 --no_exec
